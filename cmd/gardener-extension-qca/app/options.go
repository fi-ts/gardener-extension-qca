...
import (
	...
	qualyscmd "github.com/fi-ts/gardener-extension-qca/pkg/cmd"
	controller "github.com/fi-ts/gardener-extension-qca/pkg/controller/qca"
...
const ExtensionName = "extension-qca"
...
type Options struct {
	...
	qualysOptions      *qualyscmd.QCAOptions
}
...
func NewOptions() *Options {
	options := &Options{
		...
		controllerSwitches: qualyscmd.ControllerSwitchOptions(),
		reconcileOptions:   &controllercmd.ReconcilerOptions{},
	}
...
func (options *Options) run(ctx context.Context) error {
	...
	options.qualysOptions.Completed().Apply(&controller.DefaultAddOptions.Config)
